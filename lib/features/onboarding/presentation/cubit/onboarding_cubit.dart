...
class OnboardingCubit extends Cubit<OnboardingState> {
  ...
  Future<void> _generateAndShowPlan() async {
    ...
    final weight = double.parse(state.weightKg);
    final height = int.parse(state.heightCm);
    final age = int.parse(state.age);
    ...
    final profile = UserProfilesCompanion.insert(
      ...
      heightCm: height,
      weightKg: weight,
      targetWeightKg: state.targetWeightKg.isEmpty
          ? weight
          : double.parse(state.targetWeightKg),
